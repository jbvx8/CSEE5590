...
public class SQLiteDB extends SQLiteOpenHelper {
    ...
    public void create(Contact contact){
        ...
        long newContactID = db.insert(TABLE_NAME, "", values);
    }
    ...
    public void update(Contact contact){
        ...
        newValues.put(COLUMN_NAME, contact.getName());
        newValues.put(COLUMN_PHONE, contact.getPhone());

        db.update(TABLE_NAME, newValues, COLUMN_ID + "=?",
